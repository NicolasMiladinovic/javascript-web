...
rubyElt.appendChild(document.createTextNode("Ruby")); //Déf de son contenu textuel
document.getElementById("langages").appendChild(rubyElt); // Insertion du nouvel élément

var perlElt = document.createElement("li"); // Création d'un élément
perlElt.id = "perl"; // Déf de son id
perlElt.textContent = "Perl"; // Déf de son contenu textuel
// Ajout du nouvel élément avant l'id identifié par "php"
